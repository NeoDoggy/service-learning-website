  ...
  Widget build(BuildContext context) {
    return Consumer2<AuthProvider, ActivitiesProvider>(
      builder: (context, authProvider, activitiesProvider, child) {
        ...
        // 預填入姓名、email
        _nameTextController.text = authProvider.userData!.name;
        _emailTextController.text = authProvider.userData!.email;
                      ...
                      child: ElevatedButton.icon(
                        onPressed: () {
                          if ((_formKey.currentState as FormState).validate()) {
                            ...
                            authProvider.userData!.joinedActivities
                                .add(widget.activityId);
