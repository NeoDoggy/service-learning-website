...
class ActivityEditingPagePermission extends StatefulWidget {
  const ActivityEditingPagePermission(
    this.id, {
    super.key,
  });
  ...
  @override
  State<ActivityEditingPagePermission> createState() =>
      _ActivityEditingPagePermissionState();
}

class _ActivityEditingPagePermissionState
    extends State<ActivityEditingPagePermission> {
  ...
  Widget build(BuildContext context) {
    return Consumer<AuthProvider>(
      builder: (context, authProvider, child) {
        ...
        return Consumer2<ActivitiesProvider, UsersProvider>(
          builder: (context, activitiesProvider, usersProvider, child) {
            final activityData = activitiesProvider.activitiesData[widget.id]!;
            _membersUid = activityData.members;
            return Column(
